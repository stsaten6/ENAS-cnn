...
data_arg.add_argument('--data_path', type=str, default='./data')
...
learn_arg.add_argument('--shared_lr', type=float, default=0.1)
...
learn_arg.add_argument('--cnn_network_type', type=str, default='macro')
